...
function Header({ handleDrawer,title }) {
    ...
    const renderMenu = (
        ...
        >
            ...
            <MenuItem onClick={()=>{handleMenuClose();deleteToken()}}>LogOut</MenuItem>
            ...
            <AppBar position="static">
                <Toolbar className='bg-white border-b-[0.5px] border-[rgb(110,110,110)]'>
                    ...
                    <Typography
                        ...
                        noWrap
                        component="div"
                        className=' flex justify-between w-[120px] text-[rgb(110,110,110)] cursor-pointer'
                        sx={{ display: { xs: 'none', sm: 'block' } }}
                    >
                        <DescriptionIcon className=' text-yellow-400 text-[34px]' />
                        <span id='keep'>{title}</span>
                    </Typography>
                    <Search>
                        <SearchIconWrapper>
                            <SearchIcon className='text-[rgb(110,110,110)] rounded-[50%] cursor-pointer' />
                        </SearchIconWrapper>
                        <StyledInputBase
                            placeholder="Search…"
